---
title: 📋 Resumos da Estatística
date: "2023-07-12 16:30:29"
type: book
weight: 60
...
Resumos da Estatística  representa uma séries de vídeos curtos mostrando uma ideia geral sobre cada assunto da disciplina de **Estatística e Probabilidade** aplicadas às Engenharias e Ciências (EPAEC) da [UFSJ](http://ufsj.edu.br), ministradas pelo Prof. {{< mention "admin" >}}. Esse trabalho está vinculado ao <a href="{{< relref "project/ProjAPE" >}}" target="_blank"> Projeto Aprender Por Ensinar (PAPE)</a>.
