...
Com o apoio do Centro Acadêmico de Engenharia de Telecomunicações (Catel/UFSJ), iniciei, no ano de 2021, o primeiro curso para o módulo Básico, e na sequência foi realizado o módulo intermediário. Todos no formato *online*, para que o conhecimento ultrapassasse as fronteiras da Universidade. Até o presente momento, o módulo avançado que seria o último curso, está em fase de desenvolvimento. A ideia deu tanto certo, que apesar do momento de pandemia e situação difícil para o mundo, foi realizada mais de 1.000 inscrições, tanto de alunos da UFSJ, como também de alunos da América do Sul, Moçambique, Angola, dentre outros países e outros estados do Brasil. Tudo isso, realizado de forma gratuita e com emissão de certificados emitidos pelo Catel.

%A ideia desse curso foi apresentar algo diferente relacionado a maioria dos cursos em [R](http://r-project.org/), que foi sempre apresentar essa ferramenta dentro dos conceitos da área da Estatística.
%Apesar da Estatística e [R](http://r-project.org/) estarem intimamente relacionados, há muitas particularidades na aprendizagem sobre esses dois assuntos. Por exemplo, há muitos assuntos no ambiente [R](http://r-project.org/)  complexos, como os *loops*, julgados como um processo lento e com alto gasto de memória; quando na realidade, o que  ocorre é o mau entendimento do sistema de cópia de objetos. Ainda mais, essa complexidade pode aumentar quando é necessário introduzir assuntos em estatística, em que há uma necessidade matemático, tem o seu cunho filosófico de como as metodologias foram desenvolvidas. Dessa forma, o entendimento mútuo da Estatística e o ambiente [R](http://r-project.org/), pode não ter o conhecimento real que essa potencial ferramenta pode proporcionar, uma vez que muitos assuntos complexos podem estar envolvidos em uma única aula.
