...
<tbody>
  ...
  <tr>
    <td class="tg-5lw0"> <code>median()</code>  </td>
    <td class="tg-5lw0">Mediana </td>
  </tr>
  <tr>
    <td class="tg-xzvq"> <code>mfreq()</code>  </td>
    <td class="tg-xzvq">Moda</td>
  </tr>
</tbody>
</table>
</center>
...
\begin{align*}
    \bar{X} & =  \sum_{i=1}^{n}\tilde{X}_if_i /    \sum_{i=1}^{n}f_i \\
    & = \frac{31 \times 1 + \ldots + 41.6 \times 2}{20}\\
    & = 66,04~\textrm{°F}.
\end{align*}
