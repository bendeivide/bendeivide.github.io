...
# Ideia básica {background-image="EAR-rbasico-background-02.png"}
...
```{r echo = TRUE, eval=TRUE, prompt=TRUE, error=TRUE}
# Objetos
x <- 5
w <- 3:8
...
# Exemplo 5 {background-image="EAR-rbasico-background-02.png"}
...
# Exemplo 6 {background-image="EAR-rbasico-background-02.png"}
