...
- `r colorize("Dia 13/09", "#42affa")`
  ...
  - Aula 06
  - Aula 07
- `r colorize("Dia 14/09", "yellow")`
  - `r colorize("*Live* de dúvidas", "yellow")`
...
- `r colorize("Dia 20/09", "#42affa")`
  - Aula 12
  - Aula 13
  - Aula 14
  - Aula 15*
- `r colorize("Dia 21/09", "yellow")`
  - `r colorize("*Live* de dúvidas", "yellow")`
- `r colorize("Dia 22/09", "#42affa")`
  - Aula 16
  - Aula 17*
  - Aula 18
...
- `r colorize("Dia 27/09", "#42affa")`
  - Aula 19*
  - Aula 20
  - Aula 21
- `r colorize("Dia 28/09", "#42affa")`
  - Aula 22
  - Aula 23*
  - Aula 24*
  - Aula 25
- `r colorize("Dia 29/09", "yellow")`
  - `r colorize("*Live* de dúvidas", "yellow")`
...
2. Quais os três princípios do R ? Identifique-os em
termos de linhas de comandos criadas em R.
...
5. Qual a diferença entre estrutura de dados e
tipo de objetos no ambiente R?
6. Qual a relação existente entre o escopo de uma
função e os objetos do tipo ambiente (`environment`)?
7. ...
