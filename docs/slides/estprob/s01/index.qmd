...
::: {.nonincremental} Tentando verificar a eficiência de um robô desenvolvido para o mercado de ações, supondo que esse robô tem como estratégia operar apenas comprando. Para isso, aplicamos um experimento para o robô sobre 10 ativos. Será que ele está adivinhando na compra desses ativos? :::
...
::: {.notes} 📝 Mostrar a relação do Método científico com as Definições gerais da estatística (Smoothdraw) :::
...
::: {.notes} 📝 Fazer alguns exemplos na sala digital (Smoothdraw) :::
