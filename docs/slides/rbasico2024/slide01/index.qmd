---
title: "{{< fa brands r-project >}} Básico 2024 | Aula 01"
subtitle: "Entendendo o curso EAR: R básico"
...
# Ideia sobre o EAR: R básico {background-image="EAR-rbasico-background-02.png"}
...
# Instalação do R e RStudio {background-image="EAR-rbasico-background-02.png"}

- [Instalação do R](https://cran.r-project.org/)
- [Instalação do RStudio](https://posit.co/download/rstudio-desktop/)
- [Vídeo de auxílio para instalação](https://youtu.be/8_GrR3FLZJM)
